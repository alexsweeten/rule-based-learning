...
tfbs_classifier = RandomForestClassifier(criterion='entropy', n_estimators=500)
...
#n_estimators=1000 for human
#n_estimators=500 for ecoli when 4mer is used
...
df.to_csv('../result/ecoli_s70/RF-4mer+fft.csv', header=0, index=0)
#df.to_csv('../result/humanSP1/RF-3mer+fft.csv', header=0, index=0)
...
fig.savefig('../figure/ecoli_s70/feature_importance_RF-4mer+fft.png', bbox_inches='tight')
#fig.savefig('../figure/humanSP1/feature_importance_RF-3mer+fft.png', bbox_inches='tight')
plt.show()
